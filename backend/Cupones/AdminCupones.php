<?php
	...
	if($_GET['_op']){
		...
		$aParametros['url_back'] = "Cupones.php";
		switch ($op) {
			case "new":
				
					$aParametros['_op'] = _encode('new');
					
					$aParametros['datos_comercio']	= "<span style='color:#F00;font-size:11px;'>- ingrese numero de comercio o identifique al comercio desde busqueda avanzada</span>";
