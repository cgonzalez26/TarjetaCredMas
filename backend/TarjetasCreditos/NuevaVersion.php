<?
	...
	$aCond[]=" Tarjetas.idTipoEstadoTarjeta in (10,11,12)";
...
if ($result){	
  ...
  $sCadena .= " en la base de datos.</p>
  	<form action='NuevaVersion.php' id='formTarjetas' method='POST'>
  	<input type='hidden' id='URL_BAK' name='URL_BAK' value='NuevaVersion.php' />
	...
	<tr>
	   <td colspan="8" align="right">
	   	   <div> 
	   	    	<button type="button" onclick="nuevasTarjetasCreditos();"> Nueva Version </button> &nbsp;
	   	   </div>
	   </td>
	</tr> 
	</table>
...
$aParametros['FORM_BACK'] = "NuevaVersion.php";	
?>
<script>
...
function nuevasTarjetasCreditos(){
	  var mensaje="Esta seguro que desea Generar una Nueva Version las Tarjetas de Creditos seleccionadas?"; 
	  ...
	  if(band==1)
	  {
	  	 ...
	  	 if(confirm(mensaje))
	     	xajax_nuevaVersionTarjetasCreditos(sTarjetas,xajax.getFormValues('formTarjetas'));
	  }
