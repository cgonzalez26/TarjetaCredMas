...
$result = $oMysql->consultaSel("SELECT EstadosLotesCorreos.idEmpleado,EstadosLotesCorreos.idTipoEstadoLoteCorreo,TiposEstadosLotesCorreos.sNombre as 'sEstado', IFNULL(DATE_FORMAT(EstadosLotesCorreos.dFechaRegistro,'%d/%m/%Y  %H:%i'),'') as 'dFechaRegistro',EstadosLotesCorreos.sMotivo 
						FROM EstadosLotesCorreos
						LEFT JOIN TiposEstadosLotesCorreos ON TiposEstadosLotesCorreos.id = EstadosLotesCorreos.idTipoEstadoLoteCorreo
						WHERE EstadosLotesCorreos.idLoteCorreo={$_GET['id']} ORDER BY EstadosLotesCorreos.dFechaRegistro ASC");
...
<center>
	...
	<tr>
		<td align="center" style="height:25px"><b>Historial de Estado del Lote de Correo</b></td>
	</tr>
	<tr>
