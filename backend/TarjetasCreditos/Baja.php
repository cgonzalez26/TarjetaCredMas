<?
	...
	//$aCond[]=" Tarjetas.idTipoEstadoTarjeta = 14";
	...
	$aParametros['FORM_BACK'] = "Baja.php";	
?>
  ...
  $sCadena .= " en la base de datos.</p>
	...
	<tr>
	   <td colspan="8" align="right">
	   	   <div> 
	   	    	<button type="button" onclick="darBajaTarjetasCreditos();"> Dar de Baja </button> &nbsp;
	   	   </div>
	   </td>
	</tr> 
	</table>
...
function darBajaTarjetasCreditos(){
