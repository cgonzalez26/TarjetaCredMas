...
$sPermisosTarjeta=stringPermitsUser($idUsuario,2);
...
<div id="BodyTree" style="padding-left:20px;width:100%">
<center>
...
<script>
	...
	tree.loadXML("xmlPermits.php?id="+<?=$idUsuario?>,closeAllRoots);			
    ...
    function DatosUserBasic(idUser,sPermits,sPermitsAccesos,sPermisosTarjeta){
