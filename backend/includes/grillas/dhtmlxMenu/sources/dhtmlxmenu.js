	...
	this._buildMenu = function(t, parentId) {
		...
		for (var q=0; q<t.childNodes.length; q++) {
			if (t.childNodes[q].tagName == this.itemTagName) {
				...
				item["tip"] = "";
				item["hotkey"] = "";
				//agregado a fin de obtener la url que se le setea y recuperarla en el evento onclick
				item["sUrl"]= r.getAttribute("sUrl")||"";
				item["sTitulo"]= r.getAttribute("sTitulo")||"";
				item["idWinParent"]= r.getAttribute("idWinParent")||"";
				// custom css
...
/**
agregado por carlos flores 
*   @desc: returns item's url
*   @param: id - the item
*   @type: public
*/
dhtmlXMenuObject.prototype.getItemUrl = function(id) {
	return (this.itemPull[this.idPrefix+id]!=null?this.itemPull[this.idPrefix+id]["sUrl"]:"");
}
/**
agregado por carlos flores 
*   @desc: returns item's titulo
*   @param: id - the item
*   @type: public
*/
dhtmlXMenuObject.prototype.getItemTitulo = function(id) {
	return (this.itemPull[this.idPrefix+id]!=null?this.itemPull[this.idPrefix+id]["sTitulo"]:"");
}
...
*   @type: public
*/
dhtmlXMenuObject.prototype.getItemIdWinParent = function(id) {
	return (this.itemPull[this.idPrefix+id]!=null?this.itemPull[this.idPrefix+id]["idWinParent"]:"");
}