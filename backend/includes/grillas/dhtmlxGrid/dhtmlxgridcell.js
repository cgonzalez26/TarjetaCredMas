...
function eXcell_co(cell){
	...
	this.edit = function(){
						...
						this.obj.style.height=(this.cell.offsetHeight-4)+"px";
							...
							/**
                             * TwelveCubes Tom Pijsel, Added zindex 3000019
                            */
							this.list.style.zIndex = 3000019;
...
eXcell_pricen.prototype = new eXcell_price;
eXcell_pricen.prototype.setValue = function(val){
		if(isNaN(Number(val))){
			if(!(val||"") || (val||"")._dhx_trim()!="")
				val = 0;//alert("Value must be an integer")
			val = this.val || 0;
