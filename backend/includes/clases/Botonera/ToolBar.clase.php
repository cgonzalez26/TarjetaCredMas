...
class  aToolBar{
	...
	public function setIdBotonera($idBotonera = ''){
		$this->idBotonera = $idBotonera;
	}
	
	public function getIdBotonera(){
		return $this->idBotonera;
	}	
	...
	{		
		...
		if($sTipo)
		{
			...
			switch ($sTipo){
				...
				case "Solicitud":$sIcono='page.gif';break;//ClassDuplicate
				#codigo new
				case "tiposplanes24":$sIcono='tiposplanes24.png';break;
				case "editar24":$sIcono='editar24.png';break;
				case "search24":$sIcono='search24.png';break;
				case "delete24":$sIcono='delete24.png';break;
				case "warning24":$sIcono='warning24.gif';break;
				case "page24":$sIcono='page24.png';break;
				case "print24":$sIcono='print24.png';break;
				case "watch24":$sIcono='watch24.png';$style_img = 'width:24px;height:24px;';break;
				case "promociones24":$sIcono='promociones24.png';break;
				case "Ok":$sIcono='ok.png';break;
				case "Cuotas":$sIcono='Cuotas.png';break;
				case "NuevaVersion":$sIcono='new.png';break;				
				case "Resumen":$sIcono='resume.png';break;
				case "Limite":$sIcono='limite.png';break;
				case "EliminarDefinitivo":$sIcono='database_delete.png';break;
				case "Reactivar":$sIcono='reactivar.png';break;
			}	
		}	
		...
		if ($bSolo) $sCuerpo="<img src=\"../includes/templates/xhtml/others/Botonera/imgPag/$sIcono\" style='$style_img'>";
		else  $sCuerpo= "<table><tr><td><img src=\"../includes/templates/xhtml/others/Botonera/imgPag/$sIcono\" style='$style_img'></td><th style=\"font-family:Tahoma;font-size:{$bSize}pt;color:$sFont;\" >$sEtiqueta</th></tr></table> ";
	...
	public function getBotoneraToolBar($sFloat,$bOrden=false){
		...
		$aVariables['idBotonera'] = $this->getIdBotonera();
	    switch ($sFloat){
