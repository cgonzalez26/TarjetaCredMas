<form action="{FORM}" method="POST"><center>
	<div style="width:800px;">
		...
		<legend style="text-align:left;border:0px solid #FFF;"><img src='{IMAGES_DIR}/search32.png' title='buscar' alt='buscar' hspace='4' align='absmiddle' /> LISTADO DE VALORES DE PAGOS A COMERCIOS</legend>	
		...
		<table style="width:680px !important;font-size:11px;" cellspacing="2" cellpadding="2" border="0">
		 ...
		 <tr>
		  	...
		  	<td align="right" width="140">Nro. de Cheque:</td>
		  	<td width="150"><input type="text" name="iNroCheque" id="iNroCheque" value='{iNroCheque}'></td>
		 </tr>
		 <tr>
