<center>
	<form action="{FORM}" method="POST" >
		<table  class='formulario'  style="width:550px !important;border:solid 1px #CCC !important;" cellspacing="0" cellpadding="0" border="0">
		  ...
		  <tr>
			 <th width="30" height="30" align="right" style="width:130px">Comercio: &nbsp;</th>
			 <td height="30">
			 <!--<input type="text" name="sNumeroComercio" id="sNumeroComercio" maxlength="9" value='{sNumeroComercio}'>-->
			 <select id="sNumeroComercio" name="sNumeroComercio" style="width:130px;">
				{options_comercios}
			 </select>
			 </td> 
...
<script type="text/javascript">
		InputMask('dFechaConsumoDesde','99/99/9999');
		InputMask('dFechaConsumoHasta','99/99/9999');
	</script>
