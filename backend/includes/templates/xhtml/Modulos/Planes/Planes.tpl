...
<form id="formPlanes" action="AdminPlanes.php" method="POST">	
   ...
   <tr>
    <td valign="top" style="padding-top:20px">
	    ...
	    <table cellspacing="0" cellpadding="0" width="" align="center" border="0" class="TablaGeneral">
			<tbody><tr>
...
<script>
	...
	function saveDatos(){
		var Formu = document.forms['formPlanes'];
		
		if(validarDatosForm()){		
			
			if(confirm('Esta seguro de realizar esta operacion?')){
				xajax_sendFormPlanes(xajax.getFormValues('formPlanes'));
			}
