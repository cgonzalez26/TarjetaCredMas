...
<script>
	...
	var flds = "Nombre,Descripcion,Procedimiento,Estado";
	
	_mygrid.setHeader(flds);
	
	/*_mygrid.attachHeader("#text_filter,#text_filter");*/
	
	_mygrid.setInitWidths("200,200,300,100");
	
	_mygrid.setColAlign("left,left,left,left");
	
	_mygrid.setColTypes("ed,ed,ed,coro");
    
	_mygrid.setColumnIds("sNombre,sDescripcion,sStoreProcedure,sEstado");
	...
	_mygrid.init();
   	...
   	_mygrid.loadXML("xmlVariablesTiposAjustes.php");
   	

	myDataProcessor = new dataProcessor("processVariablesTiposAjustes.php");
