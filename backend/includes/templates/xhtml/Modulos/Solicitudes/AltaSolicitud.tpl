<center>
	<div id='' style='width:960px;text-align:right;margin-right:10px;'>
		...
		&nbsp;&nbsp;-->
		<a href="AdminSolicitudes.php" style='text-decoration:none;font-weight:bold;'>
	...
	<form id="formAltaSolicitud" action="AltaSolicitud.php" method="POST">
	 	...
	 	<input type='hidden' name='hdnFechaCierre' id="hdnFechaCierre" value='' />
	 	<input type='hidden' name='hdnFechaVencimiento' id="hdnFechaVencimiento" value='' />
	 	<input type='hidden' name='hdnPeriodo' id="hdnPeriodo" value='' />
		...
		<fieldset id='cuadroOficina' style="height:350px;width:960px">
		<legend> Datos de la nueva Cuenta</legend>	
			<table id='TablaCanal' cellpadding="0" cellspacing="0" class="TablaGeneral" style="width::950px" border="0">
			<tr>
			<td valign="top">
				<table id='TablaCanal' cellpadding="0" cellspacing="5" class="TablaGeneral" style="width:660px">
				<tr>
			...
			<td valign="top">
				...
				<tr>
					<th style="width:130px"> Limite de Compra:</th>
			...
			<tr>
				<td align="center" colspan="2"><input type="button" id="btnGuardar" name="btnGuardar" value="Guardar" onclick="javascript:saveDatos();" style="display:none" /></td>
			</tr>
			</table>	
		</fieldset>
	</form>
...
function saveDatos(){
	...
	{		
		...
		{		
			//alert("paso");
			xajax_altaSolicitud(xajax.getFormValues('formAltaSolicitud'));
		}	
	}		
}
...
function validarDatosForm() 
{
	...
	with (Formu)
	{
		...
		if(hdnFechaCierre.value == "" || hdnFechaVencimiento.value == "" || hdnPeriodo.value == ""){
			errores += "- Datos invalidos vuelva a selecccionar el Grupo Afinidad.\n";		
		}
		if(hdnLimiteCompra.value == 0 || hdnLimiteCredito.value == 0){
			errores += "- Datos invalidos vuelva a selecccionar el Limite.\n";		
		}
