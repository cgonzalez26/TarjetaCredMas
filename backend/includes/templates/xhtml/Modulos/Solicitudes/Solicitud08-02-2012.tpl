				...
				<td class="SubHead" align="left" bgcolor="#ffffff">
					<table id="TablaTitular" cellspacing="5" cellpadding="0" width="100%" border="0" class="TablaGeneral">
						...
						<tr>
							...
							<td valign="top">
								<select id="idSexo" name="idSexo" style="width:120px;" tabindex="16">
								{optionsSexos}
								</select>
							</td>
						</tr>
				...
				<table id="TablaCondicion" cellspacing="5" cellpadding="0" width="100%" border="0" class="TablaGeneral">
					...
					<tr>
						...
						<td class="SubHead" width="200">
							...
							<input name="sTelParticularMovilNumero" type="text" id="sTelParticularMovilNumero" class="FormTextBox" style="width:120px;" onblur="this.value=numero_parse_entero(this.value);" value="{TEL_PART_MOVIL_NUMERO}" tabindex="77" maxlength="10"/>
						...
						<td>
						<select name="idEmpresaCelularTitular" id="idEmpresaCelularTitular" class="FormTextBox" style="width:200px;" tabindex="78">
							{optionsEmpresasCelulares}
						</select>
						<br/><br/>
						</td>
						<td><input name="sMail" type="text" id="sMail" class="FormTextBox" value="{MAIL}" tabindex="79"></td>	
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td class="SubHead" width="200">
					...
					<tr>
						<td>REFERENCIA</td>
						<td class="SubHead" width="200">
							<input name="sTelContactoPrefijo" type="text" id="sTelContactoPrefijo" class="FormTextBox" style="width:50px;" onblur="this.value=numero_parse_entero(this.value);" value="{TEL_CONTACTO_PREFIJO}" tabindex="80" maxlength="4"/>&nbsp;-
							<input name="sTelContactoNumero" type="text" id="sTelContactoNumero" class="FormTextBox" style="width:120px;" onblur="this.value=numero_parse_entero(this.value);" value="{TEL_CONTACTO_NUMERO}" tabindex="81" maxlength="10"/>
						</td>
						<td class="SubHead" width="200">
							<input name="sReferenciaContacto" type="text" id="sReferenciaContacto" class="FormTextBox" style="width:200px;" value="{REF_CONTACTO}" tabindex="82" onKeyUp="aMayusculas(this.value,this.id)"/>
						</td>
						<td>
						</td>
					</tr>
