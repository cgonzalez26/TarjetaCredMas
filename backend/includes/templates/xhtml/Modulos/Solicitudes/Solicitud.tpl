   ...
   <tr>
    <td valign="top" style="padding-top:20px">
	    ...
	    <table cellspacing="0" cellpadding="0" width="90%" align="center" border="0" class="TablaGeneral">
			...
			<tr>
				<td class="SubHead" align="left" bgcolor="#ffffff">
					<table id="TablaTitular" cellspacing="5" cellpadding="0" width="100%" border="0" class="TablaGeneral">
						<tbody>
						<tr>
							<td class="subTitulo" align="left" height="30" colspan="7">
						...
						<tr>
							...
							<td class="SubHead">
							<span id="Solicitudes_plCIva_lblLabel">Condicion Iva:</span>
							</td>
						</tr>
						<tr>
							...
							<td class="SubHead">
							    <select id="idCondicionIva" name="idCondicionIva" style="width:120px;" tabindex="20" >
								{optionsCondiIva}
								</select> 
							</td>
						</tr>
						...
						<tr>
							<td class="SubHead">
							<input name="sApellidoConyuge" type="text" id="sApellidoConyuge" class="FormTextBox" onKeyUp="aMayusculas(this.value,this.id)" value="{APELLIDO_CONYUGE}" tabindex="21">
							</td>
							<td class="SubHead">
							<input name="sNombreConyuge" type="text" id="sNombreConyuge" class="FormTextBox" onKeyUp="aMayusculas(this.value,this.id)" value="{NOMBRE_CONYUGE}" tabindex="22">
							</td>						
							<td class="SubHead" valign="top">
								<select name="idTipoDocumentoConyuge" id="idTipoDocumentoConyuge" class="FormTextBox" tabindex="24">
									{optionsTipoDoc}
								</select>
							</td>
							<td class="SubHead" valign="top">
								<input name="sDocumentoConyuge" type="text" id="sDocumentoConyuge" class="FormTextBox" onblur="this.value=numero_parse_entero(this.value);" value="{DOCUMENTO_CONYUGE}" tabindex="25">
							</td>
							<td class="SubHead">
								<input name="iHijos" type="text" id="iHijos" class="FormTextBox" style="width:20px;" value="{HIJOS}" tabindex="26">
							</td>
						</tr>
						</tbody>
						</table>
						...
						<table id="TablaDomicilio" cellspacing="5" cellpadding="0" width="100%" border="0" class="TablaGeneral">
							...
							<tr>
								<td class="SubHead" align="left">
									<select name="idProvinciaTitu" id="idProvinciaTitu" class="FormTextBox" tabindex="27">
										{optionsProviTitu}
									</select>
								</td>	
								<td class="SubHead" align="left">
									<select name="idLocalidadTitu" id="idLocalidadTitu" class="FormTextBox" tabindex="28">
										{optionsLocalidades}
									</select>
								<td class="SubHead" align="left">
									<input name="sCodigoPostalTitu" type="text" id="sCodigoPostalTitu" class="FormTextBox" onchange="copiarValor(sCodigoPostalResumen,this.value)" value="{CODIGO_POSTAL}" tabindex="29" maxlength="10">
								</td>
								<td class="SubHead" align="left">
									<input name="sCalleTitu" type="text" id="sCalleTitu" class="FormTextBox" style="width:200px;" onKeyUp="aMayusculas(this.value,this.id)" onblur="copiarValor(sCalleResumen,this.value)" value="{CALLE}" tabindex="30" maxlength="45"/></td>
								<td class="SubHead" align="left">
									<input name="sNumeroCalleTitu" type="text" id="sNumeroCalleTitu" class="FormTextBox" style="width:50px;" onblur="copiarValor(sNumeroCalleResumen,this.value)" value="{NUMERO_CALLE}" tabindex="31" maxlength="6"/></td>	
							</tr>
							<tr>
								<td class="SubHead">
							...
							<tr>
								...
								<td class="SubHead" align="left">
									<input name="sBarrioTitu" type="text" id="sBarrioTitu" class="FormTextBox" style="width:200px;" onKeyUp="aMayusculas(this.value,this.id)" onblur="copiarValor(sBarrioResumen,this.value)"  value="{BARRIO}" tabindex="32" maxlength="45"/></td>
																				
								<td class="SubHead" align="left">
									<input name="sBlockTitu" type="text" id="sBlockTitu" class="FormTextBox" style="width:50px;" onblur="copiarValor(sBlockResumen,this.value)" value="{BLOCK}" tabindex="33" maxlength="4"/></td>
								<td class="SubHead" align="left">
									<input name="sPisoTitu" type="text" id="sPisoTitu" class="FormTextBox" style="width:50px;" onblur="copiarValor(sPisoResumen,this.value)" value="{PISO}" tabindex="34" maxlength="4"/></td>
								<td class="SubHead" align="left">
									<input name="sDepartamentoTitu" type="text" id="sDepartamentoTitu" class="FormTextBox" style="width:200px;" onblur="copiarValor(sDepartamentoResumen,this.value)" value="{DEPARTAMENTO}" tabindex="35" maxlength="4"/></td>	
							</tr>
							
							<tr>
								<td colspan='7'>  
									<table cellspacing="5" cellpadding="0" width='72%'> 
											<tr>
												<td class="SubHead"><span id="Solicitudes_plDomicilio_lblLabel">Entre Calles:</span></td>
												<td class="SubHead"><span id="Solicitudes_plDomicilio_lblLabel">Manzana:</span></td>
												<td class="SubHead"><span id="Solicitudes_plDomicilio_lblLabel">Grupo:</span></td>  
												<td class="SubHead"><span id="Solicitudes_plDomicilio_lblLabel">Casa:</span></td>  
												<td class="SubHead"><span id="Solicitudes_plDomicilio_lblLabel">Lote:</span></td>
												<td class="SubHead"><span id="Solicitudes_plDomicilio_lblLabel">Medidor:</span></td>
												<td class="SubHead"><span id="Solicitudes_plDomicilio_lblLabel">Otros:</span></td>	  
											</tr>
											<tr>
												<td class="SubHead" align="left"><input name="sEntreCalleTitu" type="text" id="sEntreCalleTitu" class="FormTextBox" style="width:200px;" onKeyUp="aMayusculas(this.value,this.id)" onblur="copiarValor(sEntreCalleResumen,this.value)"  value="{ENTRE_CALLE}" tabindex="36" maxlength="100"/></td>				
												<td class="SubHead" align="left"><input name="sManzanaTitu" type="text" id="sManzanaTitu" class="FormTextBox" style="width:50px;" onKeyUp="aMayusculas(this.value,this.id)" onblur="copiarValor(sManzanaResumen,this.value)" value="{MANZANA}" tabindex="37" maxlength="4"/></td>
												<td class="SubHead" align="left"><input name="sGrupoTitu" type="text" id="sGrupoTitu" class="FormTextBox" style="width:50px;" onKeyUp="aMayusculas(this.value,this.id)" onblur="copiarValor(sGrupoResumen,this.value)" value="{GRUPO}" tabindex="38" maxlength="6"/></td>			
												<td class="SubHead" align="left"><input name="sCasaTitu" type="text" id="sCasaTitu" class="FormTextBox" style="width:50px;" onKeyUp="aMayusculas(this.value,this.id)" onblur="copiarValor(sCasaResumen,this.value)" value="{CASA}" tabindex="39" maxlength="6"/></td>			
				 						        <td class="SubHead" align="left"><input name="sLoteTitu" type="text" id="sLoteTitu" class="FormTextBox" style="width:50px;" onKeyUp="aMayusculas(this.value,this.id)" onblur="copiarValor(sLoteResumen,this.value)" value="{LOTE}" tabindex="40" maxlength="6"/></td>	
				 						        <td class="SubHead" align="left"><input name="sMedidorTitu" type="text" id="sMedidorTitu" class="FormTextBox" style="width:50px;" onKeyUp="aMayusculas(this.value,this.id)" onblur="copiarValor(sMedidorResumen,this.value)" value="{MEDIDOR}" tabindex="41" maxlength="6"/></td>	
				 						        <td class="SubHead" align="left"><input name="sOtrosTitu" type="text" id="sOtrosTitu" class="FormTextBox" style="width:150px;" onKeyUp="aMayusculas(this.value,this.id)" onblur="copiarValor(sOtrosResumen,this.value)" value="{OTROS}" tabindex="42" maxlength="50"/></td>	
											</tr>																					
									</table>
								</td>
							</tr>
				...
				<tr>
					...
					<div id="dnn_ctr608_Solicitudes_pnResumen">
						...
						<table id="TablaDomicilio" cellspacing="5" cellpadding="0" width="100%" border="0" class="TablaGeneral">
							...
							<tr>
								<td class="SubHead" align="left">
									<select name="idProvinciaResumen" id="idProvinciaResumen" class="FormTextBox" tabindex="43">
										{optionsProviResumen}
									</select>
								</td>	
								<td class="SubHead" align="left">
									<select name="idLocalidadResumen" id="idLocalidadResumen" class="FormTextBox" tabindex="44">
										{optionsLocalidadesResumen}
									</select>
								<td class="SubHead" align="left">
									<input name="sCodigoPostalResumen" type="text" id="sCodigoPostalResumen" class="FormTextBox" onchange="copiarValor(sCodigoPostalResumen,this.value)" value="{CP_RESUMEN}" tabindex="45" maxlength="10">
								</td>
								<td class="SubHead" align="left">
									<input name="sCalleResumen" type="text" id="sCalleResumen" class="FormTextBox" style="width:200px;" onKeyUp="aMayusculas(this.value,this.id)"  value="{CALLE_RESUMEN}" tabindex="46" maxlength="45"/></td>
								<td class="SubHead" align="left">
									<input name="sNumeroCalleResumen" type="text" id="sNumeroCalleResumen" class="FormTextBox" style="width:50px;"  value="{NUMERO_CALLE_RESUMEN}" tabindex="47" maxlength="6"/></td>	
							</tr>
							<tr>
								<td class="SubHead">
								  <span id="Solicitudes_plDomicilio_lblLabel">Barrio:</span></td>
							...
							<tr>
								...
								<td class="SubHead" align="left">
									<input name="sBarrioResumen" type="text" id="sBarrioResumen" class="FormTextBox" style="width:200px;" onKeyUp="aMayusculas(this.value,this.id)"   value="{BARRIO_RESUMEN}" tabindex="48" maxlength="45"/></td>
																				
								<td class="SubHead" align="left">
									<input name="sBlockResumen" type="text" id="sBlockResumen" class="FormTextBox" style="width:50px;"  value="{BLOCK_RESUMEN}" tabindex="49" maxlength="4"/></td>
								<td class="SubHead" align="left">
									<input name="sPisoResumen" type="text" id="sPisoResumen" class="FormTextBox" style="width:50px;"  value="{PISO_RESUMEN}" tabindex="50" maxlength="4"/></td>
								<td class="SubHead" align="left">
									<input name="sDepartamentoResumen" type="text" id="sDepartamentoResumen" class="FormTextBox" style="width:200px;"  value="{DPTO_RESUMEN}" tabindex="51" maxlength="4"/></td>	
							</tr>
							...
							<tr>
								<td colspan='7'>  
									<table cellspacing="5" cellpadding="0" width='72%'> 
											...
											<tr>
												<td class="SubHead" align="left"><input name="sEntreCalleResumen" type="text" id="sEntreCalleResumen" class="FormTextBox" style="width:200px;" onKeyUp="aMayusculas(this.value,this.id)"   value="{ENTRE_CALLE_RESUMEN}" tabindex="52" maxlength="100"/></td>				
												<td class="SubHead" align="left"><input name="sManzanaResumen" type="text" id="sManzanaResumen" class="FormTextBox" style="width:50px;" onKeyUp="aMayusculas(this.value,this.id)"  value="{MANZANA_RESUMEN}" tabindex="53" maxlength="4"/></td>
												<td class="SubHead" align="left"><input name="sGrupoResumen" type="text" id="sGrupoResumen" class="FormTextBox" style="width:50px;" onKeyUp="aMayusculas(this.value,this.id)"  value="{GRUPO_RESUMEN}" tabindex="54" maxlength="6"/></td>			
												<td class="SubHead" align="left"><input name="sCasaResumen" type="text" id="sCasaResumen" class="FormTextBox" style="width:50px;" onKeyUp="aMayusculas(this.value,this.id)"  value="{CASA_RESUMEN}" tabindex="55" maxlength="6"/></td>			
				 						        <td class="SubHead" align="left"><input name="sLoteResumen" type="text" id="sLoteResumen" class="FormTextBox" style="width:50px;" onKeyUp="aMayusculas(this.value,this.id)"  value="{LOTE_RESUMEN}" tabindex="56" maxlength="6"/></td>	
				 						        <td class="SubHead" align="left"><input name="sMedidorResumen" type="text" id="sMedidorResumen" class="FormTextBox" style="width:50px;" onKeyUp="aMayusculas(this.value,this.id)"  value="{MEDIDOR_RESUMEN}" tabindex="57" maxlength="6"/></td>	
				 						        <td class="SubHead" align="left"><input name="sOtrosResumen" type="text" id="sOtrosResumen" class="FormTextBox" style="width:150px;" onKeyUp="aMayusculas(this.value,this.id)"  value="{OTROS_RESUMEN}" tabindex="58" maxlength="50"/></td>	
											</tr>																					
									</table>
								</td>
							</tr>
				...
				<table id="TablaCondicion" cellspacing="5" cellpadding="0" width="100%" border="0" class="TablaGeneral">
					...
					<tr>
						...
						<tr>
						<td class="SubHead" align="left">
						<input name="sRazonSocialLab" type="text" id="sRazonSocialLab" class="FormTextBox" style="width:200px;" onKeyUp="aMayusculas(this.value,this.id)" value="{RAZON_SOCIAL_LAB}" tabindex="59"/>
						</td>
						<td class="SubHead" align="left">
						<input name="sCuitEmpleador" type="text" id="sCuitEmpleador" class="FormTextBox" style="width:200px;" value="{CUIT_EMPLEADOR}" tabindex="60"/>
						</td>
						<td class="SubHead" align="left">
							<select name="idCondicionAFIPLab" id="idCondicionAFIPLab" class="FormTextBox" style="width:200px;" value="{CONDICION_AFIP_LAB}" tabindex="61">
								{optionsTiposIva}
							</select>
						</td>
						<td class="SubHead" align="left">
							<select name="idCondicionLaboral" id="idCondicionLaboral" class="FormTextBox" style="width:200px;" tabindex="62" onchange="setearCondicionAfip(this.value)">
								{optionsCondicionesLab}
							</select>
						</td>	
						<td class="SubHead" align="left">
							<input name="sReparticion" type="text" id="sReparticion" class="FormTextBox" style="width:200px;" onKeyUp="aMayusculas(this.value,this.id)" value="{REPARTICION_LAB}" tabindex="63"/>
						</td>
					</tr>		
					<tr>
						<td class="SubHead">
					...
					<tr>
						<td class="SubHead" align="left">
							<input name="sActividad" type="text" id="sActividad" class="FormTextBox" style="width:200px;" onKeyUp="aMayusculas(this.value,this.id)" value="{ACTIVIDAD_LAB}" tabindex="64"/>
						<td class="SubHead" align="left">
							<input name="sCalleLab" type="text" id="sCalleLab" class="FormTextBox" style="width:200px;" onKeyUp="aMayusculas(this.value,this.id)" value="{CALLE_LAB}" tabindex="65"/></td>
						<td class="SubHead" align="left">
							<input name="sNumeroCalleLab" type="text" id="sNumeroCalleLab" class="FormTextBox" style="width:50px;" value="{NUMERO_CALLE_LAB}" tabindex="66"/></td>
						<td class="SubHead" align="left">
							<input name="sBlockLab" type="text" id="sBlockLab" class="FormTextBox" style="width:30px;" value="{BLOCK_LAB}" tabindex="67"/></td>	
						<td>
							<table id="TablaCondicion" cellspacing="0" cellpadding="0" width="100%" border="0">
							<tr>	
							<td class="SubHead" align="left">
								<input name="sPisoLab" type="text" id="sPisoLab" class="FormTextBox" style="width:30px;" value="{PISO_LAB}" tabindex="68"/></td>
							<td class="SubHead" align="left">
								<input name="sOficinaLab" type="text" id="sOficinaLab" class="FormTextBox" style="width:30px;" value="{OFICINA_LAB}" tabindex="69"/></td>
							</tr>
							</table>
						</td>		
					</tr>
					<tr>
						...
						<tr>
						<td class="SubHead" align="left">
							<input name="sBarrioLab" type="text" id="sBarrioLab" class="FormTextBox" style="width:200px;" onKeyUp="aMayusculas(this.value,this.id)" value="{BARRIO_LAB}" tabindex="70"/></td>	
						<td class="SubHead" align="left">
							<input name="sManzanaLab" type="text" id="sManzanaLab" class="FormTextBox" style="width:30px;" onKeyUp="aMayusculas(this.value,this.id)" value="{MANZANA_LAB}" tabindex="71"/></td>								
						<td class="SubHead" align="left">
							<select name="idProvinciaLab" id="idProvinciaLab" class="FormTextBox" tabindex="72">
								{optionsProviLab}
							</select>
						</td>	
						<td class="SubHead" align="left">
							<select name="idLocalidadLab" id="idLocalidadLab" class="FormTextBox" style="width:200px" tabindex="73">
								{optionsLocalidadesLab}
							</select>
						</td>	
						<td class="SubHead" align="left">
						<input name="sCodigoPostalLab" type="text" id="sCodigoPostalLab" class="FormTextBox" style="width:100px;" value="{CP_LAB}" tabindex="74"/></td>	
					</tr>										
					<tr>
						<td class="SubHead">
						...
						<tr>
						<td class="SubHead" align="left">
						<input name="sTelLaboral1Prefijo" type="text" id="sTelLaboral1Prefijo" class="FormTextBox" style="width:50px;" onblur="this.value=numero_parse_entero(this.value);" value="{TEL1_PREFIJO}" tabindex="75" maxlength="4"/>&nbsp;-
						<input name="sTelLaboral1Numero" type="text" id="sTelLaboral1Numero" class="FormTextBox" style="width:120px;" onblur="this.value=numero_parse_entero(this.value);" value="{TEL1_NUMERO}" tabindex="76" maxlength="10"/></td>
						<td class="SubHead" align="left">
						<input name="sInterno1" type="text" id="sInterno1" class="FormTextBox" style="width:200px;" onblur="this.value=numero_parse_entero(this.value);" value="{INTERNO1}" tabindex="77"/></td>
						<td class="SubHead" align="left">
						<input name="dFechaIngreso1" type="text" id="dFechaIngreso1" class="FormTextBox" style="width:200px;" onblur="validarFecha(this,'Fecha de Ingreso 1')" value="{FECHA_INGRESO1}" tabindex="78"/></td>
						<td class="SubHead" align="left">
						<input name="sCargo1" type="text" id="sCargo1" class="FormTextBox" style="width:200px;" value="{CARGO1}" onKeyUp="aMayusculas(this.value,this.id)" tabindex="79"/></td>
						<td class="SubHead" align="left">
						<input name="fIngresoNetoMensual1" type="text" id="fIngresoNetoMensual1" class="FormTextBox" style="width:200px;" value="{ING_MESUAL1}" tabindex="80"/></td>
					</tr>
					<tr>
						<td class="SubHead">
						...
						<tr>
						<td class="SubHead" align="left">
							<input name="sTelLaboral2Prefijo" type="text" id="sTelLaboral2Prefijo" class="FormTextBox" style="width:50px;" onblur="this.value=numero_parse_entero(this.value);" value="{TEL2_PREFIJO}" tabindex="81" maxlength="4"/>&nbsp;-
							<input name="sTelLaboral2Numero" type="text" id="sTelLaboral2Numero" class="FormTextBox" style="width:120px;" onblur="this.value=numero_parse_entero(this.value);" value="{TEL2_NUMERO}" tabindex="82" maxlength="10"/></td>
						<td class="SubHead" align="left">
							<input name="sInterno2" type="text" id="sInterno2" class="FormTextBox" style="width:200px;" value="{INTERNO2}" tabindex="83"/></td>
						<td class="SubHead" align="left">
							<input name="dFechaIngreso2" type="text" id="dFechaIngreso2" class="FormTextBox" style="width:200px;" onchange="validarFecha(this,'Fecha de Ingreso 2')" value="{FECHA_INGRESO2}" tabindex="84"/></td>
						<td class="SubHead" align="left">
							<input name="sCargo2" type="text" id="sCargo2" class="FormTextBox" style="width:200px;" value="{CARGO2}" onKeyUp="aMayusculas(this.value,this.id)" tabindex="85" /></td>
						<td class="SubHead" align="left">
							<input name="fIngresoNetoMensual2" type="text" id="fIngresoNetoMensual2" class="FormTextBox" style="width:200px;" value="{ING_MESUAL2}" tabindex="86"/></td>
					</tr>		
					<tr>
					  <td class="SubHead" align="left"><span >Email Laboral:</span></td>
					  <td class="SubHead" align="left"><span >Condicion DGR:</span></td>
					  <td class="SubHead" align="left"><span title='Exencion de Retenciones Impositvas Nacionales'>Ex. Retenciones Imp. Nac.:</span></td>
					</tr>
					<tr>
					  <td class="SubHead" align="left"> <input name="sEmailLaboral" type="text" id="sEmailLaboral" class="FormTextBox" style="width:200px;"  value="{EMAIL_LABORAL}" tabindex="87" />  </td>
					  <td class="SubHead" align="left"> <select name="idTiposDgr" id="idEmpresaCelularTitular" class="FormTextBox" style="width:200px;" tabindex="88">{optionsTiposDgr}</select>  </td>
					  <td class="SubHead" align="left"> <select name="idTiposImpositivas" id="idTiposImpositivas" title='Exencion de Retenciones Impositvas Nacionales'  class="FormTextBox" style="width:200px;" tabindex="89">{optionsTiposRetencionesImpositivas}
						</select>  </td>
					</tr>
					</table>
				...
				<table id="TablaCondicion" cellspacing="5" cellpadding="0" width="100%" border="0" class="TablaGeneral">
					...
					<tr>
						...
						<td class="SubHead" width="200" style="height:25px">
							<input name="sTelParticularFijoPrefijo" type="text" id="sTelParticularFijoPrefijo" class="FormTextBox" style="width:50px;" onblur="this.value=numero_parse_entero(this.value);" value="{TEL_PART_FIJO_PREFIJO}" tabindex="90" maxlength="4"/>&nbsp;-
							<input name="sTelParticularFijoNumero" type="text" id="sTelParticularFijoNumero" class="FormTextBox" style="width:120px;" onblur="this.value=numero_parse_entero(this.value);" value="{TEL_PART_FIJO_NUMERO}" tabindex="91" maxlength="10"/><br><br>
							
							
						</td>
						<td class="SubHead" width="200">
							<input name="sTelParticularMovilPrefijo" type="text" id="sTelParticularMovilPrefijo" class="FormTextBox" style="width:50px;" onblur="this.value=numero_parse_entero(this.value);" value="{TEL_PART_MOVIL_PREFIJO}" tabindex="92" maxlength="4"/>&nbsp;-
							<input name="sTelParticularMovilNumero" type="text" id="sTelParticularMovilNumero" class="FormTextBox" style="width:120px;" onblur="this.value=numero_parse_entero(this.value);" value="{TEL_PART_MOVIL_NUMERO}" tabindex="93" maxlength="10"/>
						...
						<td>
						<select name="idEmpresaCelularTitular" id="idEmpresaCelularTitular" class="FormTextBox" style="width:200px;" tabindex="94">
							{optionsEmpresasCelulares}
						</select>
						<br/><br/>
						</td>
						<td><input name="sMail" type="text" id="sMail" class="FormTextBox" value="{MAIL}" tabindex="95"></td>	
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td class="SubHead" width="200">
					...
					<tr>
						<td>REFERENCIA</td>
						<td class="SubHead" width="200">
							<input name="sTelContactoPrefijo" type="text" id="sTelContactoPrefijo" class="FormTextBox" style="width:50px;" onblur="this.value=numero_parse_entero(this.value);" value="{TEL_CONTACTO_PREFIJO}" tabindex="96" maxlength="4"/>&nbsp;-
							<input name="sTelContactoNumero" type="text" id="sTelContactoNumero" class="FormTextBox" style="width:120px;" onblur="this.value=numero_parse_entero(this.value);" value="{TEL_CONTACTO_NUMERO}" tabindex="97" maxlength="10"/>
						</td>
						<td class="SubHead" width="200">
							<input name="sReferenciaContacto" type="text" id="sReferenciaContacto" class="FormTextBox" style="width:200px;" value="{REF_CONTACTO}" tabindex="98" onKeyUp="aMayusculas(this.value,this.id)"/>
						</td>
						<td>
						</td>
					</tr>
			...
			<tr valign="top">
				<td align="center">
					<input type="button" id="cmd_alta" name="cmd_alta" onclick="javascript:darAltaSolicitud();" value="Dar Alta" {MOSTRAR_DAR_ALTA} tabindex="99"/>&nbsp;&nbsp;
					<input type="button" id="cmd_enviar" name="cmd_enviar" onclick="javascript:sendFormSolicitud();" value="Guardar" {MOSTRAR_GUARDAR} tabindex="100"/>&nbsp;&nbsp;
					<input type="button" id="cmd_borrar" name="cmd_borrar" onclick="this.form.reset()" value="Borrar" {MOSTRAR_BORRAR} tabindex="101"/>
					<input type="button" id="cmd_volver" name="cmd_volver" onclick="window.location='{URL_PRINCIPAL}'" value="Volver" tabindex="102"/>
				</td>
			</tr>
