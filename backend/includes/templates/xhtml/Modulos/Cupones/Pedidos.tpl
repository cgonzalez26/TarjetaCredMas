...
<div style="width:860px;">
	<div style='width:700px;text-align:right;'>
		...
		&nbsp;&nbsp;			
		<a href="Pedidos.php" style='text-decoration:none;font-weight:bold;'>
...
<form id="formCupones" action="AdminPlanes.php" method="POST" name="formCupones">	
	...
	<input type="hidden" name="NotasPedidosId" id="NotasPedidosId" value="{NotasPedidosId}" />
	<input type="hidden" name="NotasPedidosCantidadCuotas" id="NotasPedidosCantidadCuotas" value="{NotasPedidosCantidadCuotas}" />	
	<input type="hidden" name="NotasPedidosImporteCuota" id="NotasPedidosImporteCuota" value="{NotasPedidosImporteCuota}" />	
	<input type="hidden" name="NotasPedidosFormaPago" id="NotasPedidosFormaPago" value="{NotasPedidosFormaPago}" />	
	<input type="hidden" name="NotasPedidosNumero" id="NotasPedidosNumero" value="{NotasPedidosNumero}" />	
	<input type="hidden" name="NotasPedidosFechaAlta" id="NotasPedidosFechaAlta" value="{NotasPedidosFechaAlta}" />	
	...
	<table cellspacing="0" cellpadding="0" width="100%" align="center" border="0" class="TablaGeneral">
		<tbody>
				...
				<td class="SubHead" align="left" bgcolor="#ffffff">
						...
						<tr>
							...
							<td colspan="3">
								...
								<input type="button" name="advanced_search_cuenta" id="advanced_search_cuenta" value="busqueda avanzada" style="" onclick="_createWindows('../Cupones/BuscarUsuario.php','usuario','usuario');" />
							</td>
						</tr>
						<tr>
							<td colspan="4">							
								...
								<tr>
									<td valign="top">
										<div style="width:300px;text-align:left;" id="datos_cuenta">
											{datos_cuenta}
										</div>
									</td>					
									<td>
										<div id='divTitleNotasPedidos' class='title_planespromo' style="width:450px;display:none">Notas de Pedidos</div>
										<div style="width:450px;height:150px;text-align:left;overflow-y: auto;" id="div_datos_pedidos">
										</div>
									</td>			
								</tr>
								</table>
						...
						<tr>
							...
							<td colspan="3">
								...
								<select id="sNumeroComercio" name="sNumeroComercio" style="width:200px;" onchange="buscarDatosComercioPorNumero();">
								{options_comercios}
								</select>
								<!--
						...
						<tr>
							<td colspan="4">
								<div style="width:300px;text-align:left;" id="div_datos_comercio">
									{datos_comercio}
								</div>
							</td>
						</tr>
						...
						<tr>
							<td>
								<span>(*)<b>Cobrador:</b></span>
							</td>
							<td>	
								<select id="idCobrador" name="idCobrador" class="FormTextBox" style="width:200px;">
								{optionsCobradores}
								</select>
							</td>
						</tr>
						<tr>
							...
							<td colspan="3">
								<textarea name="sObservacion" id="sObservacion" style="width:563px;height:40px;"></textarea>
							</td>
						</tr>
						<tr>
							<td>&nbsp;</td>
						...
						<tr>
							<td colspan="4">{SELECT_EMPLEADOS}</td>
						</tr>
						</tbody>
						</table>					
				</td>
			...
			<tr valign="top">
				<td class="SubHead" style="padding-top:5px">
					(*)Datos requeridos.
				</td>
			</tr>
			<tr valign="top">
...
{SCRIPT}
	...
	function setDatosCuentaUsuario(_icu,_user,_tarjeta,_tipotarjeta,_version,_numero_cuenta,_li,_it){
		...
		xajax_getPedidos(_numero_cuenta);
	}
	...
	function buscarDatosUsuarioPorCuenta(){		
		...
		if(_numeroCuenta != ''){
			...
			xajax_buscarDatosUsuarioPorCuentaTF(_numeroCuenta);
		}else{
	...
	function setDatosPedido(NotasPedidosId,NotasPedidosCantidadCuotas,NotasPedidosImporteCuota,NotasPedidosFormaPago,NotasPedidosNumero,NotasPedidosFechaAlta,total){
		document.getElementById('NotasPedidosId').value = NotasPedidosId;
		document.getElementById('NotasPedidosCantidadCuotas').value = NotasPedidosCantidadCuotas;
		document.getElementById('NotasPedidosImporteCuota').value = NotasPedidosImporteCuota;
		document.getElementById('NotasPedidosFormaPago').value = NotasPedidosFormaPago;
		document.getElementById('NotasPedidosNumero').value = NotasPedidosNumero;
		document.getElementById('NotasPedidosFechaAlta').value = NotasPedidosFechaAlta;
		
		document.getElementById('fImporte').value = total;
	}
</script>