		...
		<table style="width:780px !important;font-size:11px;" cellspacing="3" cellpadding="3" border="0">
		 <tr>
			...
			<td style="width:150px">
			 	<select id="idGrupoAfinidadResumen" name="idGrupoAfinidadResumen" onchange="xajax_cargarOptionsPeriodos(this.value)">{optionsGrupos}</select>
			</td>		
		  	<td align="right" width="100">Periodo<sup>*</sup>:</td>
		  	<td width="150" id="tdPeriodos">
		  		<select id="dPeriodoResumen" style="width:150px;" name="dPeriodoResumen" disabled="">
