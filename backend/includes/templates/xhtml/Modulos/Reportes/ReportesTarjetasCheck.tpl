...
<!--{pathBrowser}-->
<form action="javascript:void(0);" method="GET" name="form_search" id="form_search"><center>
	<div style="width:720px;">
		...
		<table style="width:680px !important;font-size:11px;" cellspacing="2" cellpadding="2" border="0">
		 ...
		 <tr>
			<td align="center" colspan="4">
				<button type='button' name='cmd_buttons' id="cmd_buttons" style="width:120px;padding:5px;" onclick="javascript:search_form();return false;"> buscar </button>
...
<script type='text/javascript'>
	...
	function search_form(){
			...
			xajax_reportesTarjetasCheck(xajax.getFormValues('form_search'));
	...
	function procesarPolizasTACheck(){
		_imageLoading_('div_message_operations','buscando...');
		
		xajax_procesarPolizasTACheck(xajax.getFormValues('form_table_object'));
	}
	...
	function printReportesTarjetasCheck(){
