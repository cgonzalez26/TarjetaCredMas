		...
		<table style="width:780px !important;font-size:11px;" cellspacing="3" cellpadding="3" border="0">
		 <tr>
			...
			<td style="width:150px">
			 	<select id="idGrupoAfinidadReporteResumen" name="idGrupoAfinidadReporteResumen">{optionsGrupos}</select>
			</td>		
		  	<td align="right" width="100">Periodo<sup>*</sup>:</td>
		  	<td width="150">
		  		<select id="dPeriodoReporteResumen" name="dPeriodoReporteResumen" onchange="mostrarFechas(this.value)">{optionsPeriodos}</select>
		  	</td>
