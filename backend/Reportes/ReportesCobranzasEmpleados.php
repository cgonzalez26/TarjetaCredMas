<?php
	...
	$oXajax->register( XAJAX_FUNCTION ,"reporteCobranzasEmpleados");
	...
	$tableHTML = parserTemplate( TEMPLATES_XHTML_DIR . "/Modulos/Reportes/ReportesCobranzasEmpleados.tpl",$configure);		
